...
public static class CalendarViewAstBuilder
{
    ...
    public static AstUnit Build()
    {
        ...
        string inputPath = Path.Combine(basePath, "run", "result", "antlr", "input", "CalendarView.pas");
        ...
        var listener = new CalendarViewAstListener();
    ...
    {
        string basePath = GetBasePath();
        string outputPath = Path.Combine(basePath, "result", "ast_output", "CalendarView.ast");
        var unit = Build();
