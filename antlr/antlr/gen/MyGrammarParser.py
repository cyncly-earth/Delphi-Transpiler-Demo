...
class MyGrammarParser ( Parser ):
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def programHeading(self):
            return self.getTypedRuleContext(MyGrammarParser.ProgramHeadingContext,0)
        ...
        def DOT(self):
            return self.getToken(MyGrammarParser.DOT, 0)

        def EOF(self):
            return self.getToken(MyGrammarParser.EOF, 0)

        def INTERFACE(self):
            return self.getToken(MyGrammarParser.INTERFACE, 0)
    ...
    def program(self):
        ...
        try:
            ...
            if _la==68:
                self.state = 195
                self.match(MyGrammarParser.INTERFACE)


            self.state = 198
            self.block()
            self.state = 199
            self.match(MyGrammarParser.DOT)
            self.state = 200
    ...
    class ProgramHeadingContext(ParserRuleContext):
        ...
        def PROGRAM(self):
            return self.getToken(MyGrammarParser.PROGRAM, 0)
        ...
        def identifierList(self):
            return self.getTypedRuleContext(MyGrammarParser.IdentifierListContext,0)
        ...
        def UNIT(self):
            return self.getToken(MyGrammarParser.UNIT, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_programHeading
    ...
    def programHeading(self):
        ...
        localctx = MyGrammarParser.ProgramHeadingContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [29]:
                self.enterOuterAlt(localctx, 1)
                self.state = 202
                self.match(MyGrammarParser.PROGRAM)
                self.state = 203
                self.identifier()
                self.state = 208
                self._errHandler.sync(self)
                ...
                self.state = 212
                self.match(MyGrammarParser.UNIT)
                self.state = 213
                self.identifier()
                self.state = 214
                self.match(MyGrammarParser.SEMI)
    ...
    class IdentifierContext(ParserRuleContext):
        ...
        def IDENT(self):
            return self.getToken(MyGrammarParser.IDENT, 0)
    ...
    def identifier(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 218
            self.match(MyGrammarParser.IDENT)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class BlockContext(ParserRuleContext):
        ...
        def labelDeclarationPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.LabelDeclarationPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.LabelDeclarationPartContext,i)


        def constantDefinitionPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ConstantDefinitionPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ConstantDefinitionPartContext,i)


        def typeDefinitionPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.TypeDefinitionPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.TypeDefinitionPartContext,i)


        def variableDeclarationPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.VariableDeclarationPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.VariableDeclarationPartContext,i)


        def procedureAndFunctionDeclarationPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ProcedureAndFunctionDeclarationPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ProcedureAndFunctionDeclarationPartContext,i)


        def usesUnitsPart(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.UsesUnitsPartContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.UsesUnitsPartContext,i)


        def IMPLEMENTATION(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.IMPLEMENTATION)
            else:
                return self.getToken(MyGrammarParser.IMPLEMENTATION, i)
        ...
        try:
            ...
            while ((((_la - 8)) & ~0x3f) == 0 and ((1 << (_la - 8)) & -6917529026297847551) != 0):
                ...
                if token in [21]:
                    ...
                    self.state = 226
                    self.match(MyGrammarParser.IMPLEMENTATION)
                    pass
                else:
                    raise NoViableAltException(self)
    ...
    class UsesUnitsPartContext(ParserRuleContext):
        ...
        def USES(self):
            return self.getToken(MyGrammarParser.USES, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_usesUnitsPart
    ...
    def usesUnitsPart(self):
        ...
        localctx = MyGrammarParser.UsesUnitsPartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 8, self.RULE_usesUnitsPart)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 234
            self.match(MyGrammarParser.USES)
            self.state = 235
            self.identifierList()
            self.state = 236
            self.match(MyGrammarParser.SEMI)
    ...
    class LabelDeclarationPartContext(ParserRuleContext):
        ...
        def LABEL(self):
            return self.getToken(MyGrammarParser.LABEL, 0)

        def label(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.LabelContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.LabelContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_labelDeclarationPart
    ...
    def labelDeclarationPart(self):
        ...
        localctx = MyGrammarParser.LabelDeclarationPartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 10, self.RULE_labelDeclarationPart)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 238
            self.match(MyGrammarParser.LABEL)
            self.state = 239
            self.label()
            self.state = 244
            self._errHandler.sync(self)
    ...
    class LabelContext(ParserRuleContext):
        ...
        def unsignedInteger(self):
            return self.getTypedRuleContext(MyGrammarParser.UnsignedIntegerContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_label
    ...
    def label(self):
        ...
        localctx = MyGrammarParser.LabelContext(self, self._ctx, self.state)
    ...
    class ConstantDefinitionPartContext(ParserRuleContext):
        ...
        def CONST(self):
            return self.getToken(MyGrammarParser.CONST, 0)

        def constantDefinition(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ConstantDefinitionContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ConstantDefinitionContext,i)


        def SEMI(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.SEMI)
            else:
                return self.getToken(MyGrammarParser.SEMI, i)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_constantDefinitionPart
    ...
    def constantDefinitionPart(self):
        ...
        localctx = MyGrammarParser.ConstantDefinitionPartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 14, self.RULE_constantDefinitionPart)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 251
            self.match(MyGrammarParser.CONST)
            self.state = 255 
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while True:
    ...
    class ConstantDefinitionContext(ParserRuleContext):
        ...
        def constant(self):
            return self.getTypedRuleContext(MyGrammarParser.ConstantContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_constantDefinition
    ...
    def constantDefinition(self):
        ...
        localctx = MyGrammarParser.ConstantDefinitionContext(self, self._ctx, self.state)
    ...
    class ConstantChrContext(ParserRuleContext):
        ...
        def CHR(self):
            return self.getToken(MyGrammarParser.CHR, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_constantChr
    ...
    def constantChr(self):
        ...
        localctx = MyGrammarParser.ConstantChrContext(self, self._ctx, self.state)
        self.enterRule(localctx, 18, self.RULE_constantChr)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 263
            self.match(MyGrammarParser.CHR)
            self.state = 264
            self.match(MyGrammarParser.LPAREN)
            self.state = 265
            self.unsignedInteger()
    ...
    class ConstantContext(ParserRuleContext):
        ...
        def unsignedNumber(self):
            return self.getTypedRuleContext(MyGrammarParser.UnsignedNumberContext,0)


        def sign(self):
            return self.getTypedRuleContext(MyGrammarParser.SignContext,0)
        ...
        def constantChr(self):
            return self.getTypedRuleContext(MyGrammarParser.ConstantChrContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_constant
    ...
    def constant(self):
        ...
        localctx = MyGrammarParser.ConstantContext(self, self._ctx, self.state)
    ...
    class UnsignedNumberContext(ParserRuleContext):
        ...
        def unsignedReal(self):
            return self.getTypedRuleContext(MyGrammarParser.UnsignedRealContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_unsignedNumber
    ...
    def unsignedNumber(self):
        ...
        localctx = MyGrammarParser.UnsignedNumberContext(self, self._ctx, self.state)
    ...
    class UnsignedIntegerContext(ParserRuleContext):
        ...
        def NUM_INT(self):
            return self.getToken(MyGrammarParser.NUM_INT, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_unsignedInteger
    ...
    def unsignedInteger(self):
        ...
        localctx = MyGrammarParser.UnsignedIntegerContext(self, self._ctx, self.state)
        self.enterRule(localctx, 24, self.RULE_unsignedInteger)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 284
            self.match(MyGrammarParser.NUM_INT)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class UnsignedRealContext(ParserRuleContext):
        ...
        def NUM_REAL(self):
            return self.getToken(MyGrammarParser.NUM_REAL, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_unsignedReal
    ...
    def unsignedReal(self):
        ...
        localctx = MyGrammarParser.UnsignedRealContext(self, self._ctx, self.state)
        self.enterRule(localctx, 26, self.RULE_unsignedReal)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 286
            self.match(MyGrammarParser.NUM_REAL)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class SignContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_sign
    ...
    def sign(self):
        ...
        localctx = MyGrammarParser.SignContext(self, self._ctx, self.state)
    ...
    class Bool_Context(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_bool_
    ...
    def bool_(self):
        ...
        localctx = MyGrammarParser.Bool_Context(self, self._ctx, self.state)
    ...
    class StringContext(ParserRuleContext):
        ...
        def STRING_LITERAL(self):
            return self.getToken(MyGrammarParser.STRING_LITERAL, 0)
    ...
    def string(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 292
            self.match(MyGrammarParser.STRING_LITERAL)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class TypeDefinitionPartContext(ParserRuleContext):
        ...
        def typeDefinition(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.TypeDefinitionContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.TypeDefinitionContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_typeDefinitionPart
    ...
    def typeDefinitionPart(self):
        ...
        localctx = MyGrammarParser.TypeDefinitionPartContext(self, self._ctx, self.state)
    ...
    class TypeDefinitionContext(ParserRuleContext):
        ...
        def type_(self):
            return self.getTypedRuleContext(MyGrammarParser.Type_Context,0)


        def functionType(self):
            return self.getTypedRuleContext(MyGrammarParser.FunctionTypeContext,0)


        def procedureType(self):
            return self.getTypedRuleContext(MyGrammarParser.ProcedureTypeContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_typeDefinition
    ...
    def typeDefinition(self):
        ...
        localctx = MyGrammarParser.TypeDefinitionContext(self, self._ctx, self.state)
    ...
    class FunctionTypeContext(ParserRuleContext):
        ...
        def FUNCTION(self):
            return self.getToken(MyGrammarParser.FUNCTION, 0)

        def COLON(self):
            return self.getToken(MyGrammarParser.COLON, 0)

        def resultType(self):
            return self.getTypedRuleContext(MyGrammarParser.ResultTypeContext,0)


        def formalParameterList(self):
            return self.getTypedRuleContext(MyGrammarParser.FormalParameterListContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_functionType
    ...
    def functionType(self):
        ...
        localctx = MyGrammarParser.FunctionTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 38, self.RULE_functionType)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 309
            self.match(MyGrammarParser.FUNCTION)
            self.state = 311
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==55:
    ...
    class ProcedureTypeContext(ParserRuleContext):
        ...
        def PROCEDURE(self):
            return self.getToken(MyGrammarParser.PROCEDURE, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_procedureType
    ...
    def procedureType(self):
        ...
        localctx = MyGrammarParser.ProcedureTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 40, self.RULE_procedureType)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 316
            self.match(MyGrammarParser.PROCEDURE)
            self.state = 318
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==55:
    ...
    class Type_Context(ParserRuleContext):
        ...
        def simpleType(self):
            return self.getTypedRuleContext(MyGrammarParser.SimpleTypeContext,0)


        def structuredType(self):
            return self.getTypedRuleContext(MyGrammarParser.StructuredTypeContext,0)


        def pointerType(self):
            return self.getTypedRuleContext(MyGrammarParser.PointerTypeContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_type_
    ...
    def type_(self):
        ...
        localctx = MyGrammarParser.Type_Context(self, self._ctx, self.state)
    ...
    class SimpleTypeContext(ParserRuleContext):
        ...
        def scalarType(self):
            return self.getTypedRuleContext(MyGrammarParser.ScalarTypeContext,0)


        def subrangeType(self):
            return self.getTypedRuleContext(MyGrammarParser.SubrangeTypeContext,0)


        def typeIdentifier(self):
            return self.getTypedRuleContext(MyGrammarParser.TypeIdentifierContext,0)


        def stringtype(self):
            return self.getTypedRuleContext(MyGrammarParser.StringtypeContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_simpleType
    ...
    def simpleType(self):
        ...
        localctx = MyGrammarParser.SimpleTypeContext(self, self._ctx, self.state)
    ...
    class ScalarTypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_scalarType
    ...
    def scalarType(self):
        ...
        localctx = MyGrammarParser.ScalarTypeContext(self, self._ctx, self.state)
    ...
    class SubrangeTypeContext(ParserRuleContext):
        ...
        def constant(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ConstantContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ConstantContext,i)


        def DOTDOT(self):
            return self.getToken(MyGrammarParser.DOTDOT, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_subrangeType
    ...
    def subrangeType(self):
        ...
        localctx = MyGrammarParser.SubrangeTypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.constant()
            self.state = 336
            self.match(MyGrammarParser.DOTDOT)
            self.state = 337
            self.constant()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class TypeIdentifierContext(ParserRuleContext):
        ...
        def BOOLEAN(self):
            return self.getToken(MyGrammarParser.BOOLEAN, 0)

        def INTEGER(self):
            return self.getToken(MyGrammarParser.INTEGER, 0)

        def REAL(self):
            return self.getToken(MyGrammarParser.REAL, 0)

        def STRING(self):
            return self.getToken(MyGrammarParser.STRING, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_typeIdentifier
    ...
    def typeIdentifier(self):
        ...
        localctx = MyGrammarParser.TypeIdentifierContext(self, self._ctx, self.state)
    ...
    class StructuredTypeContext(ParserRuleContext):
        ...
        def PACKED(self):
            return self.getToken(MyGrammarParser.PACKED, 0)

        def unpackedStructuredType(self):
            return self.getTypedRuleContext(MyGrammarParser.UnpackedStructuredTypeContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_structuredType
    ...
    def structuredType(self):
        ...
        localctx = MyGrammarParser.StructuredTypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [27]:
                self.enterOuterAlt(localctx, 1)
                self.state = 343
                self.match(MyGrammarParser.PACKED)
                self.state = 344
    ...
    class UnpackedStructuredTypeContext(ParserRuleContext):
        ...
        def arrayType(self):
            return self.getTypedRuleContext(MyGrammarParser.ArrayTypeContext,0)


        def recordType(self):
            return self.getTypedRuleContext(MyGrammarParser.RecordTypeContext,0)


        def setType(self):
            return self.getTypedRuleContext(MyGrammarParser.SetTypeContext,0)


        def fileType(self):
            return self.getTypedRuleContext(MyGrammarParser.FileTypeContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_unpackedStructuredType
    ...
    def unpackedStructuredType(self):
        ...
        localctx = MyGrammarParser.UnpackedStructuredTypeContext(self, self._ctx, self.state)
    ...
    class StringtypeContext(ParserRuleContext):
        ...
        def LBRACK(self):
            return self.getToken(MyGrammarParser.LBRACK, 0)

        def RBRACK(self):
            return self.getToken(MyGrammarParser.RBRACK, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_stringtype
    ...
    def stringtype(self):
        ...
        localctx = MyGrammarParser.StringtypeContext(self, self._ctx, self.state)
    ...
    class ArrayTypeContext(ParserRuleContext):
        ...
        def ARRAY(self):
            return self.getToken(MyGrammarParser.ARRAY, 0)

        def LBRACK(self):
            return self.getToken(MyGrammarParser.LBRACK, 0)

        def typeList(self):
            return self.getTypedRuleContext(MyGrammarParser.TypeListContext,0)
        ...
        def OF(self):
            return self.getToken(MyGrammarParser.OF, 0)

        def componentType(self):
            return self.getTypedRuleContext(MyGrammarParser.ComponentTypeContext,0)


        def LBRACK2(self):
            return self.getToken(MyGrammarParser.LBRACK2, 0)

        def RBRACK2(self):
            return self.getToken(MyGrammarParser.RBRACK2, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_arrayType
    ...
    def arrayType(self):
        ...
        localctx = MyGrammarParser.ArrayTypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 362
                self.match(MyGrammarParser.ARRAY)
                self.state = 363
                self.match(MyGrammarParser.LBRACK)
                self.state = 364
                self.typeList()
                ...
                self.match(MyGrammarParser.ARRAY)
                self.state = 370
                self.match(MyGrammarParser.LBRACK2)
                self.state = 371
                self.typeList()
                self.state = 372
                self.match(MyGrammarParser.RBRACK2)
                self.state = 373
                self.match(MyGrammarParser.OF)
                self.state = 374
                self.componentType()
    ...
    class TypeListContext(ParserRuleContext):
        ...
        def indexType(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.IndexTypeContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.IndexTypeContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_typeList
    ...
    def typeList(self):
        ...
        localctx = MyGrammarParser.TypeListContext(self, self._ctx, self.state)
    ...
    class IndexTypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_indexType
    ...
    def indexType(self):
        ...
        localctx = MyGrammarParser.IndexTypeContext(self, self._ctx, self.state)
    ...
    class ComponentTypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_componentType
    ...
    def componentType(self):
        ...
        localctx = MyGrammarParser.ComponentTypeContext(self, self._ctx, self.state)
    ...
    class RecordTypeContext(ParserRuleContext):
        ...
        def RECORD(self):
            return self.getToken(MyGrammarParser.RECORD, 0)

        def END(self):
            return self.getToken(MyGrammarParser.END, 0)

        def fieldList(self):
            return self.getTypedRuleContext(MyGrammarParser.FieldListContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_recordType
    ...
    def recordType(self):
        ...
        localctx = MyGrammarParser.RecordTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 66, self.RULE_recordType)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 390
            self.match(MyGrammarParser.RECORD)
            self.state = 392
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==5 or _la==77:
    ...
    class FieldListContext(ParserRuleContext):
        ...
        def fixedPart(self):
            return self.getTypedRuleContext(MyGrammarParser.FixedPartContext,0)
        ...
        def variantPart(self):
            return self.getTypedRuleContext(MyGrammarParser.VariantPartContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_fieldList
    ...
    def fieldList(self):
        ...
        localctx = MyGrammarParser.FieldListContext(self, self._ctx, self.state)
    ...
    class FixedPartContext(ParserRuleContext):
        ...
        def recordSection(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.RecordSectionContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.RecordSectionContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_fixedPart
    ...
    def fixedPart(self):
        ...
        localctx = MyGrammarParser.FixedPartContext(self, self._ctx, self.state)
    ...
    class RecordSectionContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_recordSection
    ...
    def recordSection(self):
        ...
        localctx = MyGrammarParser.RecordSectionContext(self, self._ctx, self.state)
    ...
    class VariantPartContext(ParserRuleContext):
        ...
        def CASE(self):
            return self.getToken(MyGrammarParser.CASE, 0)

        def tag(self):
            return self.getTypedRuleContext(MyGrammarParser.TagContext,0)
        ...
        def variant(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.VariantContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.VariantContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_variantPart
    ...
    def variantPart(self):
        ...
        localctx = MyGrammarParser.VariantPartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 74, self.RULE_variantPart)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 416
            self.match(MyGrammarParser.CASE)
            self.state = 417
            self.tag()
            self.state = 418
            self.match(MyGrammarParser.OF)
    ...
    def tag(self):
        ...
        localctx = MyGrammarParser.TagContext(self, self._ctx, self.state)
    ...
    class VariantContext(ParserRuleContext):
        ...
        def constList(self):
            return self.getTypedRuleContext(MyGrammarParser.ConstListContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_variant
    ...
    def variant(self):
        ...
        localctx = MyGrammarParser.VariantContext(self, self._ctx, self.state)
    ...
    class SetTypeContext(ParserRuleContext):
        ...
        def SET(self):
            return self.getToken(MyGrammarParser.SET, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_setType
    ...
    def setType(self):
        ...
        localctx = MyGrammarParser.SetTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 80, self.RULE_setType)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 440
            self.match(MyGrammarParser.SET)
            self.state = 441
            self.match(MyGrammarParser.OF)
            self.state = 442
            self.baseType()
    ...
    class FileTypeContext(ParserRuleContext):
        ...
        def FILE(self):
            return self.getToken(MyGrammarParser.FILE, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_fileType
    ...
    def fileType(self):
        ...
        localctx = MyGrammarParser.FileTypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 446
                self.match(MyGrammarParser.FILE)
                self.state = 447
                self.match(MyGrammarParser.OF)
                self.state = 448
                self.type_()
    ...
    class PointerTypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_pointerType
    ...
    def pointerType(self):
        ...
        localctx = MyGrammarParser.PointerTypeContext(self, self._ctx, self.state)
    ...
    class VariableDeclarationPartContext(ParserRuleContext):
        ...
        def VAR(self):
            return self.getToken(MyGrammarParser.VAR, 0)

        def variableDeclaration(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.VariableDeclarationContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.VariableDeclarationContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_variableDeclarationPart
    ...
    def variableDeclarationPart(self):
        ...
        localctx = MyGrammarParser.VariableDeclarationPartContext(self, self._ctx, self.state)
        self.enterRule(localctx, 88, self.RULE_variableDeclarationPart)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 455
            self.match(MyGrammarParser.VAR)
            self.state = 456
    ...
    class ProcedureAndFunctionDeclarationPartContext(ParserRuleContext):
        ...
        def procedureOrFunctionDeclaration(self):
            return self.getTypedRuleContext(MyGrammarParser.ProcedureOrFunctionDeclarationContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_procedureAndFunctionDeclarationPart
    ...
    def procedureAndFunctionDeclarationPart(self):
        ...
        localctx = MyGrammarParser.ProcedureAndFunctionDeclarationPartContext(self, self._ctx, self.state)
    ...
    class ProcedureOrFunctionDeclarationContext(ParserRuleContext):
        ...
        def procedureDeclaration(self):
            return self.getTypedRuleContext(MyGrammarParser.ProcedureDeclarationContext,0)


        def functionDeclaration(self):
            return self.getTypedRuleContext(MyGrammarParser.FunctionDeclarationContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_procedureOrFunctionDeclaration
    ...
    def procedureOrFunctionDeclaration(self):
        ...
        localctx = MyGrammarParser.ProcedureOrFunctionDeclarationContext(self, self._ctx, self.state)
    ...
    class ProcedureDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_procedureDeclaration
    ...
    def procedureDeclaration(self):
        ...
        localctx = MyGrammarParser.ProcedureDeclarationContext(self, self._ctx, self.state)
    ...
    class FormalParameterListContext(ParserRuleContext):
        ...
        def formalParameterSection(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.FormalParameterSectionContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.FormalParameterSectionContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_formalParameterList
    ...
    def formalParameterList(self):
        ...
        localctx = MyGrammarParser.FormalParameterListContext(self, self._ctx, self.state)
    ...
    class FormalParameterSectionContext(ParserRuleContext):
        ...
        def parameterGroup(self):
            return self.getTypedRuleContext(MyGrammarParser.ParameterGroupContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_formalParameterSection
    ...
    def formalParameterSection(self):
        ...
        localctx = MyGrammarParser.FormalParameterSectionContext(self, self._ctx, self.state)
    ...
    class ParameterGroupContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_parameterGroup
    ...
    def parameterGroup(self):
        ...
        localctx = MyGrammarParser.ParameterGroupContext(self, self._ctx, self.state)
    ...
    class IdentifierListContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_identifierList
    ...
    def identifierList(self):
        ...
        localctx = MyGrammarParser.IdentifierListContext(self, self._ctx, self.state)
    ...
    class ConstListContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_constList
    ...
    def constList(self):
        ...
        localctx = MyGrammarParser.ConstListContext(self, self._ctx, self.state)
    ...
    class FunctionDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_functionDeclaration
    ...
    def functionDeclaration(self):
        ...
        localctx = MyGrammarParser.FunctionDeclarationContext(self, self._ctx, self.state)
    ...
    class ResultTypeContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_resultType
    ...
    def resultType(self):
        ...
        localctx = MyGrammarParser.ResultTypeContext(self, self._ctx, self.state)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def label(self):
            return self.getTypedRuleContext(MyGrammarParser.LabelContext,0)
        ...
        def unlabelledStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.UnlabelledStatementContext,0)
    ...
    class UnlabelledStatementContext(ParserRuleContext):
        ...
        def simpleStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.SimpleStatementContext,0)


        def structuredStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.StructuredStatementContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_unlabelledStatement
    ...
    def unlabelledStatement(self):
        ...
        localctx = MyGrammarParser.UnlabelledStatementContext(self, self._ctx, self.state)
    ...
    class SimpleStatementContext(ParserRuleContext):
        ...
        def procedureStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.ProcedureStatementContext,0)


        def gotoStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.GotoStatementContext,0)


        def emptyStatement_(self):
            return self.getTypedRuleContext(MyGrammarParser.EmptyStatement_Context,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_simpleStatement
    ...
    def simpleStatement(self):
        ...
        localctx = MyGrammarParser.SimpleStatementContext(self, self._ctx, self.state)
    ...
    class AssignmentStatementContext(ParserRuleContext):
        ...
        def variable(self):
            return self.getTypedRuleContext(MyGrammarParser.VariableContext,0)
    ...
    class VariableContext(ParserRuleContext):
        ...
        def AT(self):
            return self.getToken(MyGrammarParser.AT, 0)
        ...
        def LBRACK(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.LBRACK)
            else:
                return self.getToken(MyGrammarParser.LBRACK, i)
        ...
        def RBRACK(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.RBRACK)
            else:
                return self.getToken(MyGrammarParser.RBRACK, i)

        def LBRACK2(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.LBRACK2)
            else:
                return self.getToken(MyGrammarParser.LBRACK2, i)

        def RBRACK2(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.RBRACK2)
            else:
                return self.getToken(MyGrammarParser.RBRACK2, i)

        def DOT(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.DOT)
            else:
                return self.getToken(MyGrammarParser.DOT, i)

        def POINTER(self, i:int=None):
            if i is None:
                return self.getTokens(MyGrammarParser.POINTER)
            else:
                return self.getToken(MyGrammarParser.POINTER, i)
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def simpleExpression(self):
            return self.getTypedRuleContext(MyGrammarParser.SimpleExpressionContext,0)


        def relationaloperator(self):
            return self.getTypedRuleContext(MyGrammarParser.RelationaloperatorContext,0)
    ...
    class RelationaloperatorContext(ParserRuleContext):
        ...
        def NOT_EQUAL(self):
            return self.getToken(MyGrammarParser.NOT_EQUAL, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_relationaloperator
    ...
    def relationaloperator(self):
        ...
        localctx = MyGrammarParser.RelationaloperatorContext(self, self._ctx, self.state)
    ...
    class SimpleExpressionContext(ParserRuleContext):
        ...
        def additiveoperator(self):
            return self.getTypedRuleContext(MyGrammarParser.AdditiveoperatorContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_simpleExpression
    ...
    def simpleExpression(self):
        ...
        localctx = MyGrammarParser.SimpleExpressionContext(self, self._ctx, self.state)
    ...
    class AdditiveoperatorContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_additiveoperator
    ...
    def additiveoperator(self):
        ...
        localctx = MyGrammarParser.AdditiveoperatorContext(self, self._ctx, self.state)
    ...
    class TermContext(ParserRuleContext):
        ...
        def signedFactor(self):
            return self.getTypedRuleContext(MyGrammarParser.SignedFactorContext,0)


        def multiplicativeoperator(self):
            return self.getTypedRuleContext(MyGrammarParser.MultiplicativeoperatorContext,0)
    ...
    class MultiplicativeoperatorContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_multiplicativeoperator
    ...
    def multiplicativeoperator(self):
        ...
        localctx = MyGrammarParser.MultiplicativeoperatorContext(self, self._ctx, self.state)
    ...
    class SignedFactorContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_signedFactor
    ...
    def signedFactor(self):
        ...
        localctx = MyGrammarParser.SignedFactorContext(self, self._ctx, self.state)
    ...
    class FactorContext(ParserRuleContext):
        ...
        def functionDesignator(self):
            return self.getTypedRuleContext(MyGrammarParser.FunctionDesignatorContext,0)


        def unsignedConstant(self):
            return self.getTypedRuleContext(MyGrammarParser.UnsignedConstantContext,0)


        def set_(self):
            return self.getTypedRuleContext(MyGrammarParser.Set_Context,0)
        ...
        def bool_(self):
            return self.getTypedRuleContext(MyGrammarParser.Bool_Context,0)
    ...
    class UnsignedConstantContext(ParserRuleContext):
        ...
        def NIL(self):
            return self.getToken(MyGrammarParser.NIL, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_unsignedConstant
    ...
    def unsignedConstant(self):
        ...
        localctx = MyGrammarParser.UnsignedConstantContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [79, 80]:
                ...
                self.enterOuterAlt(localctx, 4)
                self.state = 638
                self.match(MyGrammarParser.NIL)
                pass
            else:
                raise NoViableAltException(self)
    ...
    class FunctionDesignatorContext(ParserRuleContext):
        ...
        def parameterList(self):
            return self.getTypedRuleContext(MyGrammarParser.ParameterListContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_functionDesignator
    ...
    def functionDesignator(self):
        ...
        localctx = MyGrammarParser.FunctionDesignatorContext(self, self._ctx, self.state)
    ...
    class ParameterListContext(ParserRuleContext):
        ...
        def actualParameter(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ActualParameterContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ActualParameterContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_parameterList
    ...
    def parameterList(self):
        ...
        localctx = MyGrammarParser.ParameterListContext(self, self._ctx, self.state)
    ...
    class Set_Context(ParserRuleContext):
        ...
        def elementList(self):
            return self.getTypedRuleContext(MyGrammarParser.ElementListContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_set_
    ...
    def set_(self):
        ...
        localctx = MyGrammarParser.Set_Context(self, self._ctx, self.state)
    ...
    class ElementListContext(ParserRuleContext):
        ...
        def element(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ElementContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ElementContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_elementList
    ...
    def elementList(self):
        ...
        localctx = MyGrammarParser.ElementListContext(self, self._ctx, self.state)
    ...
    class ElementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_element
    ...
    def element(self):
        ...
        localctx = MyGrammarParser.ElementContext(self, self._ctx, self.state)
    ...
    class ProcedureStatementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_procedureStatement
    ...
    def procedureStatement(self):
        ...
        localctx = MyGrammarParser.ProcedureStatementContext(self, self._ctx, self.state)
    ...
    class ActualParameterContext(ParserRuleContext):
        ...
        def parameterwidth(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.ParameterwidthContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.ParameterwidthContext,i)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_actualParameter
    ...
    def actualParameter(self):
        ...
        localctx = MyGrammarParser.ActualParameterContext(self, self._ctx, self.state)
    ...
    class ParameterwidthContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_parameterwidth
    ...
    def parameterwidth(self):
        ...
        localctx = MyGrammarParser.ParameterwidthContext(self, self._ctx, self.state)
    ...
    class GotoStatementContext(ParserRuleContext):
        ...
        def GOTO(self):
            return self.getToken(MyGrammarParser.GOTO, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_gotoStatement
    ...
    def gotoStatement(self):
        ...
        localctx = MyGrammarParser.GotoStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 156, self.RULE_gotoStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 697
            self.match(MyGrammarParser.GOTO)
            self.state = 698
            self.label()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class EmptyStatement_Context(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_emptyStatement_
    ...
    def emptyStatement_(self):
        ...
        localctx = MyGrammarParser.EmptyStatement_Context(self, self._ctx, self.state)
    ...
    class Empty_Context(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_empty_

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterEmpty_" ):
                listener.enterEmpty_(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitEmpty_" ):
                listener.exitEmpty_(self)
    ...
    def empty_(self):
        ...
        localctx = MyGrammarParser.Empty_Context(self, self._ctx, self.state)
    ...
    class StructuredStatementContext(ParserRuleContext):
        ...
        def conditionalStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.ConditionalStatementContext,0)


        def repetetiveStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.RepetetiveStatementContext,0)


        def withStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.WithStatementContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_structuredStatement
    ...
    def structuredStatement(self):
        ...
        localctx = MyGrammarParser.StructuredStatementContext(self, self._ctx, self.state)
    ...
    class CompoundStatementContext(ParserRuleContext):
        ...
        def statements(self):
            return self.getTypedRuleContext(MyGrammarParser.StatementsContext,0)
    ...
    class StatementsContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_statements
    ...
    def statements(self):
        ...
        localctx = MyGrammarParser.StatementsContext(self, self._ctx, self.state)
    ...
    class ConditionalStatementContext(ParserRuleContext):
        ...
        def caseStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.CaseStatementContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_conditionalStatement
    ...
    def conditionalStatement(self):
        ...
        localctx = MyGrammarParser.ConditionalStatementContext(self, self._ctx, self.state)
    ...
    class CaseStatementContext(ParserRuleContext):
        ...
        def caseListElement(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MyGrammarParser.CaseListElementContext)
            else:
                return self.getTypedRuleContext(MyGrammarParser.CaseListElementContext,i)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_caseStatement
    ...
    def caseStatement(self):
        ...
        localctx = MyGrammarParser.CaseStatementContext(self, self._ctx, self.state)
    ...
    class CaseListElementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_caseListElement
    ...
    def caseListElement(self):
        ...
        localctx = MyGrammarParser.CaseListElementContext(self, self._ctx, self.state)
    ...
    class RepetetiveStatementContext(ParserRuleContext):
        ...
        def repeatStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.RepeatStatementContext,0)


        def forStatement(self):
            return self.getTypedRuleContext(MyGrammarParser.ForStatementContext,0)


        def getRuleIndex(self):
            return MyGrammarParser.RULE_repetetiveStatement
    ...
    def repetetiveStatement(self):
        ...
        localctx = MyGrammarParser.RepetetiveStatementContext(self, self._ctx, self.state)
    ...
    class RepeatStatementContext(ParserRuleContext):
        ...
        def REPEAT(self):
            return self.getToken(MyGrammarParser.REPEAT, 0)
        ...
        def UNTIL(self):
            return self.getToken(MyGrammarParser.UNTIL, 0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_repeatStatement
    ...
    def repeatStatement(self):
        ...
        localctx = MyGrammarParser.RepeatStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 180, self.RULE_repeatStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 766
            self.match(MyGrammarParser.REPEAT)
            self.state = 767
            self.statements()
            self.state = 768
            self.match(MyGrammarParser.UNTIL)
            self.state = 769
            self.expression()
        except RecognitionException as re:
            localctx.exception = re
    ...
    class ForStatementContext(ParserRuleContext):
        ...
        def forList(self):
            return self.getTypedRuleContext(MyGrammarParser.ForListContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_forStatement
    ...
    def forStatement(self):
        ...
        localctx = MyGrammarParser.ForStatementContext(self, self._ctx, self.state)
    ...
    class ForListContext(ParserRuleContext):
        ...
        def initialValue(self):
            return self.getTypedRuleContext(MyGrammarParser.InitialValueContext,0)


        def finalValue(self):
            return self.getTypedRuleContext(MyGrammarParser.FinalValueContext,0)


        def TO(self):
            return self.getToken(MyGrammarParser.TO, 0)

        def DOWNTO(self):
            return self.getToken(MyGrammarParser.DOWNTO, 0)

        def getRuleIndex(self):
            return MyGrammarParser.RULE_forList
    ...
    def forList(self):
        ...
        localctx = MyGrammarParser.ForListContext(self, self._ctx, self.state)
    ...
    class InitialValueContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_initialValue
    ...
    def initialValue(self):
        ...
        localctx = MyGrammarParser.InitialValueContext(self, self._ctx, self.state)
    ...
    class FinalValueContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_finalValue
    ...
    def finalValue(self):
        ...
        localctx = MyGrammarParser.FinalValueContext(self, self._ctx, self.state)
    ...
    class WithStatementContext(ParserRuleContext):
        ...
        def WITH(self):
            return self.getToken(MyGrammarParser.WITH, 0)

        def recordVariableList(self):
            return self.getTypedRuleContext(MyGrammarParser.RecordVariableListContext,0)
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_withStatement
    ...
    def withStatement(self):
        ...
        localctx = MyGrammarParser.WithStatementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 190, self.RULE_withStatement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 786
            self.match(MyGrammarParser.WITH)
            self.state = 787
    ...
    class RecordVariableListContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MyGrammarParser.RULE_recordVariableList
    ...
    def recordVariableList(self):
        ...
        localctx = MyGrammarParser.RecordVariableListContext(self, self._ctx, self.state)
